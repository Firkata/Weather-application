...
namespace WeatherApp
{
    ...
    public class MainActivity : Activity
    {
        ...
        private AlertDialog.Builder CreateConnectionDialog()
        {
            AlertDialog.Builder alertDialog = new AlertDialog.Builder(this);
            alertDialog.SetTitle("Connection Error");
            alertDialog.SetMessage("Please turn on Internet Connection");
            alertDialog.SetNeutralButton("OK", delegate {Finish();});
        ...
        private List<HourlyForecastModel> HalfDayForecast(List<HourlyForecast> halfDayForecast)
        {
            ...
            for (int i = 0; i < 11; i++)
            {
                ...
                hourlyForecast.ImageResource = ImageHelper.ImagePicker(halfDayForecast[i].IconPhrase, halfDayForecast[i].DateTime.Hour);
